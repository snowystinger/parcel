  ...
  optimize({bundleGraph}) {
    ...
    bundleGraph.traverseBundles(bundle => {
      ...
      for (let candidate of candidates) {
        ...
        if (!exceedsParallelRequestLimit(bundleGraph, bundleGroups)) {
...
function exceedsParallelRequestLimit(
  bundleGraph: MutableBundleGraph,
  bundleGroups: Iterable<BundleGroup>,
): boolean {
  return Array.from(bundleGroups).every(
    group =>
